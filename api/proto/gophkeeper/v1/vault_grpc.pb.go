...
const (
	VaultService_CreateSecret_FullMethodName = "/gophkeeper.v1.VaultService/CreateSecret"
	VaultService_GetSecret_FullMethodName    = "/gophkeeper.v1.VaultService/GetSecret"
	VaultService_ListSecrets_FullMethodName  = "/gophkeeper.v1.VaultService/ListSecrets"
	VaultService_UpdateSecret_FullMethodName = "/gophkeeper.v1.VaultService/UpdateSecret"
	VaultService_DeleteSecret_FullMethodName = "/gophkeeper.v1.VaultService/DeleteSecret"
	VaultService_SyncSecrets_FullMethodName  = "/gophkeeper.v1.VaultService/SyncSecrets"
)
...
func (c *vaultServiceClient) SyncSecrets(ctx context.Context, in *SyncSecretsRequest, opts ...grpc.CallOption) (*SyncSecretsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncSecretsResponse)
	err := c.cc.Invoke(ctx, VaultService_SyncSecrets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVaultServiceServer) SyncSecrets(context.Context, *SyncSecretsRequest) (*SyncSecretsResponse, error) {
...
func _VaultService_SyncSecrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncSecretsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VaultServiceServer).SyncSecrets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VaultService_SyncSecrets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VaultServiceServer).SyncSecrets(ctx, req.(*SyncSecretsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VaultService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VaultService_SyncSecrets_Handler,
		},
	},
